...
例えばまわりを巻き込んで以下のような良いサイクルを回せるようになりたいです。
...
すべてを自分一人の力で達成するのは困難ですが、チームで上記のような状態を作ることができれば文化祭前夜が永続するようなプロダクト開発ができると思うんですよね。手段は問わず、まわりの力を借りながらこのように「エンジニアの成果が事業や経営の成長にしっかりと結びついた状態」を作ること、そしてそれが可能なチームやアーキテクチャを作ることが今の私のテーマです。
