...
「画像を定期的にクローリングする機能」「画像にメタデータを付与するSPA管理画面」「商品レコメンド機能」「ペイメント機能」など、プロダクトに必要な機能開発を一通り担当しました。最終的にはピボットしたのですが、当初はtoCサービスとして育てていく想定だったため、iOSアプリ開発もその中で2年ほど経験しています。
